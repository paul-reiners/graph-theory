...
male_connectome_graph_df = male_connectome_graph_df[1:]
male_edges = {(r[0], r[1]): int(r[2]) for _, r in male_connectome_graph_df.iterrows()}
female_edges = {(r[0], r[1]): int(r[2]) for _, r in read_csv("./data/in/vnc_matching_challenge/female_connectome_graph.csv.gz")[1:].iterrows()}
matching = {r[0]: r[1] for _, r in read_csv("./data/in/vnc_matching_challenge/vnc_matching_submission_benchmark_5154247.csv.gz")[1:].iterrows()}
alignment = 0
